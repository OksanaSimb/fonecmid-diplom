...
//++Симбирёва О.С 28.06.26

	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "3afd9cf1-ce73-4529-b71c-79cab1275be5";
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСЗаявкамиКлиентовРасширенный");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля); 
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя = "Специалист";
	ОписаниеПрофиля.Идентификатор = "54b0196f-2a2e-46f2-a2a0-1df91a2a095c";
	...
	ОписаниеПрофиля.Идентификатор = "71e65291-b457-44ba-97c9-eb1cbaf2b81f";
	...
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
	ОписаниеПрофиля.Роли.Добавить("ПросмотрСвязанныеДокументы");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РаботаСОбработкойМассовоеСозданиеРеализаций"); 
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя = "КадровикРасчетчикт";
	ОписаниеПрофиля.Идентификатор = "7b80616d-6010-4af5-8fe4-90438c796986";
	...
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
	ОписаниеПрофиля.Роли.Добавить("ПросмотрСвязанныеДокументы");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РасчетЗарплат");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля); 
